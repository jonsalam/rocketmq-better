 ...
 */
@Slf4j
public class ConcurrentMessageHandler extends AbstractMessageHandler {
    private final ConcurrentMessageListener messageListener;

    public ConcurrentMessageHandler(ConsumerConfig config, ConcurrentMessageListener messageListener) {
        super(config);
