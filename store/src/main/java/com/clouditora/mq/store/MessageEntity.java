...
public class MessageEntity extends Message {
    ...
    public void setPropertyBytes(byte[] bytes) {
        ...
        Map<String, String> map = UtilAll.string2Properties(properties);
    ...
    public byte[] getPropertyBytes() {
        ...
        return UtilAll.properties2Bytes(properties);
    }

    @Override
    public void setProperties(Map<String, String> properties) {
        super.setProperties(properties);
        this.propertyBytes = UtilAll.properties2Bytes(properties);
    }
}
